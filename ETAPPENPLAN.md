...
1. **Keine Etappe gilt als abgeschlossen, solange nicht jeder Punkt ihrer
   Abschlussbedingungen erfüllt ist.** Ein Punkt darf nicht in eine spätere
   Etappe verschoben werden.
2. **Verschiebungen sind nur mit ausdrücklicher Zustimmung möglich** und werden
   in dieser Datei festgehalten — mit Grund und neuer Etappe.
3. **Am Ende jeder Etappe steht ein Bericht**: was erledigt wurde, was offen
   blieb, welche Prüfungen liefen. Kein „fertig" ohne diesen Abgleich.
4. **Fehlt ein externer Zugang**, wird der Code trotzdem vollständig
...
5. **Jede Etappe endet grün**: Lint, Typecheck, alle Tests, Build.
...
- [ ] Ein Lauf gegen die echte Schnittstelle — **nur dieser Punkt** darf auf
      den Zeitpunkt verschoben werden, an dem ein Schlüssel vorliegt
